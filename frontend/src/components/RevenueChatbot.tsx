  ...
  useEffect(() => {
    ...
    if (!apiKey) {
      ...
      setMessages([
        {
          id: "setup-error",
          content: "⚠️ AI Assistant Setup Required\n\nTo use the Business Advisor, you need to:\n1. Get your API key from https://console.groq.com/\n2. Create a .env file in the frontend directory\n3. Add VITE_GROQ_API_KEY=your_api_key_here to the .env file\n4. Restart the development server\n\nOnce configured, I can help explain cargo solutions and revenue recovery in simple business terms!",
          sender: "bot",
          timestamp: new Date()
        }
      ]);
          ...
          <Box sx={{ p: 2, borderTop: "1px solid #e0e0e0", bgcolor: "white" }}>
            <Box sx={{ display: "flex", gap: 1 }}>
              <TextField
                ...
                placeholder={
                  apiKeyError
                    ? "Configure API key to enable Business Advisor"
                    : "Ask me anything about cargo solutions, revenue recovery, or business decisions in simple terms..."
                }
                value={inputMessage}
